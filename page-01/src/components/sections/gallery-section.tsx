...
export function GallerySection() {
  ...
  const images = [
    { src: "/images/mono-001.webp", alt: "Modern architecture at sunrise" },
    { src: "/images/mono-002.webp", alt: "Modern architecture in daylight" },
    { src: "/images/mono-03.png", alt: "Modern architecture at dusk" },
    { src: "/images/mono-04.png", alt: "Modern architecture at night" },
  ];
