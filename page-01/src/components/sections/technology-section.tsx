        ...
        <div className="flex h-full w-full items-center justify-center">
          ...
          >
            ...
            >
              ...
              <div 
                className="absolute inset-0 flex flex-col items-center justify-center px-6 text-center font-antihero"
              >
