...
const sideImages = [
  {
    src: "/images/hero-side-01.png",
    alt: "Modern architecture with corten steel",
    position: "left",
    span: 1,
  },
  {
    src: "/images/hero-side-02.png",
    alt: "Aerial view of modern home",
    position: "left",
    span: 1,
  },
  {
    src: "/images/hero-side-03.png",
    alt: "Interior view with landscape",
    position: "right",
    span: 1,
  },
  {
    src: "/images/hero-side-04.png",
        ...
        <div className="flex h-full w-full items-center justify-center">
          ...
          >
            ...
            >
              ...
              >
                <h1 className="font-antihero pt-4 whitespace-nowrap text-[30vw] font-bold leading-[0.8] tracking-tighter text-black/55">
