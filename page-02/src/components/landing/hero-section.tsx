...
export function HeroSection() {
  ...
  return (
    <section className="relative min-h-screen flex flex-col justify-center items-start overflow-hidden bg-black">
      {/* Orbital compute visual */}
      <div className="absolute inset-0 z-0">
        <img
          src="/images/hero.png"
          alt="Luminous compute network in a dark server room"
      ...
      <div className="relative z-10 w-full max-w-[1400px] mx-auto px-6 lg:px-12 py-32 lg:py-40">
        ...
        >
          <span className="inline-flex items-center gap-3 text-sm font-mono text-white/60">
            ...
            AI operations for ambitious teams
          </span>
        </div>
        ...
        <div className="mb-12">
          ...
          >
            <span className="block whitespace-nowrap">Turn complexity into</span>
      ...
      >
        <div className="max-w-[1400px] mx-auto flex items-start gap-10 lg:gap-20">
          {[
            { value: "3500+", label: "workflows in motion" },
            { value: "99.7%", label: "workflow reliability" },
