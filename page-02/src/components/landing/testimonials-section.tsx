...
export function TestimonialsSection() {
  ...
  return (
    <section ref={sectionRef} className="relative py-32 lg:py-40 bg-mist-950 text-white overflow-hidden">
                ...
                {testimonials.map((t, idx) => (
                  <button
                    ...
                    className={`px-4 py-2 text-sm border transition-all ${
                      idx === activeIndex 
                        ? "border-background/40 text-white" 
                        : "border-background/10 text-white/40 hover:border-background/30"
                    }`}
                  >
                    {t.company}
                  </button>
